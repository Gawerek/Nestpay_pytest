from userInterFace.Pages.pages import GetTokenPage, SendTokenPage, ChooseMethodPaymentPage, CardDetailsInputPage, \
    ResultPageWithError, CreditAgricoleStatusPage, CCloginPage, CCHomePage, CCMerchantAdministrationPanel, CCUpdateMerchantPage, \
BOIPAloginPage, SendTokenBOIPAPage, DCCCardDetailsPayPage, ResultPage, PaHomePage, PaOrdersPage
...
def show_result(webdriver, ass_errMsg=None, ass_response=None, show_result_page_class=ResultPageWithError):
    ...
    if isinstance(show_result_page, ResultPageWithError) and show_result_page.errMsg_text_element.get_attribute('value'):
